...
class Model():
    ...
    def forward(self,input,regularizer):
        ...
        logits_conv1=tf.layers.conv2d(
            inputs=input,filters=32,kernel_size=5,strides=1,padding="SAME",activation=None,
        ...
        logits_conv2 = tf.layers.conv2d(
            inputs=logits_conv1, filters=64, kernel_size=5, strides=1, padding="SAME", activation=None,
        ...
        logits=tf.layers.dense(inputs=logits_flatten,units=10,activation=None,
